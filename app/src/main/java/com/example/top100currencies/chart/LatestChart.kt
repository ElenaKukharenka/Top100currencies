...
//объявляем объект класса LineData, который инкапсулирует все данные для графика
        val data = LineData()
        ...
        //add marker
        //включаем опцию отрисовки маркера
        chart.setDrawMarkers(true)
        chart.marker =
            MyMarkerView(context, R.layout.custom_marker_view)

//параметры отображения осей,надписей,цвета
        val xl = chart.xAxis
